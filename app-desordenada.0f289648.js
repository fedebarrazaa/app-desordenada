...
parcelHelpers.export(exports, "messyWord", ()=>messyWord);
var _resultBox = require("./components/result-box"); //IMPORTA result-box.ts
function messyWord(word) {
    return word.split('').sort(()=>0.5 - Math.random()).join('');
}

},{"./components/result-box":"gUHlA","@parcel/transformer-js/src/esmodule-helpers.js":"d7bnd"}],"gUHlA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _mainTs = require("../main.ts"); //IMPORTAMOS LA FUNCION DEL ARCHIVO MAIN.TS
class MiBox extends HTMLElement {
    ...
    buttonEvent(div) {
        ...
        boton?.addEventListener('submit', (event)=>{
            ...
            const valor = boton.querySelector('input[type="text"]'); //BUSCA EL ELEMNTO input... DENTRO DEL form
            const input = valor.value; //EXTRAE EL TEXTO QUE EL USUARIO ESCRIBIO
            const messyWordApp = (0, _mainTs.messyWord)(input); //LLAMA A LA FUNCION DE main.ts Y GUARDA EL RESULTADO
...
exports.default = MiBox;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"d7bnd","../main.ts":"gNc1f"}],"d7bnd":[function(require,module,exports,__globalThis) {
...
},{}]},["arUBD","gNc1f"], "gNc1f", "parcelRequire6871", {})

//# sourceMappingURL=app-desordenada.0f289648.js.map
